...
<div class="panel panel-default">
		...
		<div class="panel-body">
			<form class="form-horizontal" role="form" action="?subtopic=register" method="post">
				<fieldset>
					...
					<div class="form-group">
						...
						<div class="col-lg-9">
							<div class="checkbox">
          						<label><input type="checkbox" required> By creating an account I agree to the <a href="?subtopic=rules" target="_blank">Burmourne rules and shop agreement</a>. Violating the rules may result in a banishment or deletion of all my accounts.</label>
        					</div>
						</div>
					</div>

					<div class="text-center">
						<button type="submit" class="nk-btn nk-btn-color-primary" name=step value=docreate>Submit</button>
						<button type="reset" class="nk-btn nk-btn-color-warning">Cancel</button>
					</div>
