...
if ($action == '')
{
	...
	if ($logged)
		$main_content .= '<a class="btn btn-sm btn-success pull-right" style="top:4px;position:relative;" href="?view=guilds&action=createguild"><i style="class="fa fa-plus"></i> Create a new guild</a>';
